        ...
        >
          ...
          >
            ...
            <ul className="gap-4 text-white font-light flex flex-col ">
              <li>
                <Link className="hover:underline" href="/fr">
                  Accueil
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/fr/about">
                  À propos
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/fr/gamme">
                  Gamme
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/fr/production">
                  Production
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/fr/durabilite">
                  Durabilité
                </Link>
              </li>
              <li>

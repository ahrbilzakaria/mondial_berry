      ...
      >
        <div>
          ...
          <p className="font-thin tracking-wide pt-2 text-md lg:text-3xl md:text-2xl text-center md:text-left">
            Cultivating excellence, harvesting trust.
          </p>
        </div>
        <motion.div
          initial={{ opacity: 0, y: 40 }}
        ...
        >
          <HeaderNbCard number={100} description="Hectares of fields" />
          <HeaderNbCard number={12} description="countries" />
          <HeaderNbCard number={200} description="Collaborators" />
        </motion.div>
      </motion.div>
      <HeaderCard />
    </header>

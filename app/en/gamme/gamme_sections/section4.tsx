  ...
  return (
    ...
    >
      <div className="w-[80%] mx-auto flex gap-4 flex-wrap items-center">
        ...
        >
          DISCOVER THE TASTE OF FRESHNESS AT MONDIAL BERRY
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          Experience the difference in every bite with Mondial Berry's premium
          range of berries. Our commitment to quality and sustainability makes us
          the trusted choice for superior products.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}

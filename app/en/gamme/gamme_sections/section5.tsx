      ...
      >
        ...
        >
          ...
          <div className="space-y-2 ">
            <p className="font-bold md:text-2xl text-xl ">Health & Well-being</p>
            <p className="text-md md:text-xl">
              Our fruits are rich in vitamins, minerals, and antioxidants, contributing to a healthy and balanced diet.
            </p>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <div className="space-y-2 ">
            <p className="font-bold md:text-2xl text-xl ">Superior taste</p>
            <p className="text-md md:text-xl">
              Grown for their exceptional flavor, they bring a gourmet and nutritious touch to your daily dishes.
            </p>
          </div>
        </motion.div>
      </motion.div>

    ...
    <div className="w-[80%] mx-auto flex flex-col gap-12 mt-16">
      ...
      >
        ...
        <p className="text-white md:text-2xl text-md text-center ">
          We grow the best fruits in the world
        </p>
      </motion.div>
      <motion.div
      ...
      >
        <div className="text-center mx-auto">
          <h2 className="text-3xl md:text-4xl max-w-3xl italic font-semibold text-center mx-auto ">
            Experience the freshness of premium red fruits
          </h2>

          <p className="text-lg md:text-xl text-center mx-auto tracking-wide max-w-4xl mt-4">
            Our commitment to excellence ensures that every berry is bursting with flavor, nutrients, and freshness. Discover the difference with our carefully grown and harvested raspberries, strawberries, blueberries, and blackberries.
          </p>
        </div>
      </motion.div>
    </div>

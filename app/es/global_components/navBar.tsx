    ...
    <nav className="flex items-center justify-between px-6 md:py-4 py-2 w-[80%] mx-auto rounded-full bg-white/10 backdrop-blur-[22px] mt-6 relative">
      ...
      <ul className="gap-4 text-white font-light lg:flex hidden">
        <li>
          <Link
            href="/es"
            className={pathName === "/es" ? "font-bold text-secondary" : ""}
          >
            Inicio
          </Link>
        </li>
        <li>
          <Link
            href="/es/about"
            className={
              pathName === "/es/about" ? "font-bold text-secondary" : ""
            }
          >
            Sobre nosotros
          </Link>
        ...
        <li>
          <Link
            href="/es/gamme"
            className={
              pathName === "/es/gamme" ? "font-bold text-secondary" : ""
            }
          >
            Gama
          </Link>
        ...
        <li>
          <Link
            href="/es/production"
            className={
              pathName === "/es/production" ? "font-bold text-secondary" : ""
            }
          >
            Producción
          </Link>
        ...
        <li>
          <Link
            href="/es/durabilite"
            className={
              pathName === "/es/durabilite" ? "font-bold text-secondary" : ""
            }
          >
            Sostenibilidad
          </Link>

      ...
      >
        ...
        >
          ...
          <div className="space-y-2 ">
            <p className="font-bold md:text-2xl text-xl ">Salud y Bienestar</p>
            <p className="text-md md:text-xl">
              Nuestras frutas son ricas en vitaminas, minerales y antioxidantes,
              contribuyendo a una alimentación sana y equilibrada.
            </p>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <div className="space-y-2 ">
            <p className="font-bold md:text-2xl text-xl ">Sabor superior</p>
            <p className="text-md md:text-xl">
              Cultivadas por su sabor excepcional, aportan un toque delicioso y
              nutritivo a tus platos diarios.
            </p>
          </div>
        </motion.div>
      </motion.div>

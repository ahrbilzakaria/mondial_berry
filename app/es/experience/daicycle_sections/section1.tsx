    ...
    <div className="w-[80%] mx-auto flex flex-col gap-12 mt-16">
      ...
      >
        ...
        <p className="text-white md:text-2xl text-md text-center ">
          Cultivamos las mejores frutas del mundo
        </p>
      </motion.div>
      <motion.div
      ...
      >
        <div className="text-center mx-auto">
          <h2 className="text-3xl md:text-4xl max-w-3xl italic font-semibold text-center mx-auto ">
            Vive la frescura de las frutas rojas premium
          </h2>

          <p className="text-lg md:text-xl text-center mx-auto tracking-wide max-w-4xl mt-4">
            Nuestro compromiso con la excelencia garantiza que cada baya esté llena de sabor, nutrientes y frescura. Descubre la diferencia con nuestras frambuesas, fresas, arándanos y moras cuidadosamente cultivadas y recolectadas.
          </p>
        </div>
      </motion.div>
    </div>
